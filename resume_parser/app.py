...
class ResumeApp:
    ...
    def render_home(self):
        ...
        hero_section(
            "Smart Resume AI",
            "Transform your career with AI-powered resume analysis and building. Get personalized insights and take a mock AI driven interview to test your skills."
        )
        ...
        feature_card(
            "fas ",
            "AI based Interview",
            "Upload your resume, select the preferred job description and experience an AI driven interview."
        )
